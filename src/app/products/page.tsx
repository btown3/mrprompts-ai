  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      ...
      <p className="mt-3 max-w-xl text-zinc-500">
        ...
        Download and use immediately. No coding required.
      </p>
      ...
      {loading ? (
        <div className="mt-10 text-center text-sm text-zinc-400">Loading products...</div>
      ) : (
      ...
      {!loading && filtered.length === 0 && (
        <div className="mt-10 rounded-xl border border-dashed border-zinc-300 p-12 text-center dark:border-zinc-700">
          ...
          <p className="mt-2 text-sm text-zinc-500">
            New products ship regularly. Subscribe to the newsletter to get notified.
          </p>
        </div>
      )}

      <div className="mt-16 rounded-xl bg-zinc-900 p-8 text-center dark:bg-zinc-800">
        <h2 className="text-xl font-bold text-white">Want to build your own?</h2>
        <p className="mx-auto mt-2 max-w-md text-sm text-zinc-400">
          The Build Tracks teach you the system behind all of these products.
        </p>
        <div className="mt-6 flex justify-center gap-4">
          ...
          <Link href="/build" className="inline-flex h-10 items-center justify-center rounded-lg border border-zinc-600 px-6 text-sm font-semibold text-white transition hover:bg-zinc-800">Build Tracks</Link>
        </div>
      </div>
    </div>
  );
