    ...
    <article className="mx-auto max-w-3xl px-6 py-20">
      ...
      <section className="mt-16 rounded-xl border border-zinc-200 bg-zinc-50 p-8 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="mt-4 space-y-4 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
          <p>Andrej Karpathy wrote about building personal knowledge bases with LLMs in early 2026. He found that the key differentiator was not which model you use but how you organize the knowledge it works with. Structured, interlinked articles consistently produce better output than dumping raw sources into a conversation.</p>
          <p>Google DeepMind&apos;s research on retrieval-augmented generation backs this up. AI models produce fewer hallucinations and more accurate responses when they reference a curated knowledge base rather than relying on training data alone. Your wiki functions the same way: sources are the retrieval corpus, wiki articles are the compiled knowledge, and queries pull synthesized answers grounded in specific evidence.</p>
          <p>Anthropic&apos;s long-context research adds another dimension. Structured reference documents outperform ad-hoc instructions by 40 to 60 percent on task quality. The CLAUDE.md schema applies this directly. Instead of re-explaining your topic every session, you give the AI an organized reference it reads first.</p>
          <p>Research teams, intelligence analysts, and knowledge management professionals have used variations of this architecture for decades. The difference now is that an LLM can do the compilation and synthesis work that used to require a team.</p>
        </div>
      </section>
