    ...
    <article className="mx-auto max-w-3xl px-6 py-20">
      ...
      <div className="mt-12 space-y-10 text-zinc-600 leading-relaxed dark:text-zinc-400">
        ...
        <section>
          ...
          <p className="mt-3"><strong>How to identify champions:</strong> They are the ones who have already tried ChatGPT or Claude on their own. They ask questions about AI in meetings. They share articles about it. They scored 4+ on the AI fluency assessment. Find them. Give them resources and access first. Let them succeed visibly.</p>
        ...
        <section>
          ...
          <p className="mt-3"><strong>Weeks 1-2: Assess.</strong> Run the AI fluency assessment. Identify champions. Map the highest-value tasks for AI across departments. Set baseline metrics.</p>
